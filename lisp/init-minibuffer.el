...
(with-eval-after-load 'org (require 'consult-org))
...
;; 不预览
(consult-customize consult-git-grep consult-grep consult-bookmark consult-recent-file consult-buffer :sort nil :preview-key nil)

;; 根据 file history 排序
(consult-customize consult-fd :sort t :history 'consult--find-history) ;; remember recent find
