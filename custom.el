...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ranger company rainbow-mode live-py-mode yasnippet-snippets ob-go markdown-toc treemacs-persp treemacs-magit treemacs-projectile treemacs-evil gotest go-gen-test go-guru go-tag quelpa no-littering use-package))
